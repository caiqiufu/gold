...
namespace uClient.Broker
{
	...
	public class Client : M4.Client.Client
	{
		...
		public static new ICore CreateCore()
		{
			...
			var versionInfo = FileVersionInfo.GetVersionInfo(Application.StartupPath + "\\zyj_mF4.exe");
		...
		/// <summary>
		/// 老版本  Broker.OpenPositions
		/// 当前持有仓位列表
		/// </summary>
		public IList<Position> OpenPositionsOld => UpdatePositions(Broker.OpenPositions);
		...
		public override void RegisterEvents()
		{
			...
			Broker.OpenPositionsUpdated += (sender, e) => {
				foreach (var openPosition in OpenPositionsOld)

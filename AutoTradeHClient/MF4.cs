...
namespace uClient.Broker
{
    public class MF4 : PlatformInf
    {
        ...
        {
            //更新账户余额
            DBHelper.updateAccountBalance(_Broker.BrokerCode, _Account.UserCode, Math.Round((double)_Client.AccountInfo.Balance, 2), (double)_Client.AccountInfo.TotalEquity, (double)_Client.AccountInfo.UsedMargin, (double)_Client.AccountInfo.UsableMargin);
        }

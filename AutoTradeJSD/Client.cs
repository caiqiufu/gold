...
namespace uClient.Broker
{
    ...
    public class Client : M4.Client.Client
    {
        ...
        /// 当前持有仓位列表
        /// </summary>
        public override IList<Position> OpenPositions => UpdatePositions(Broker.OpenPositions);
        ...
        public static new ICore CreateCore()
        {
            ...
            var versionInfo = FileVersionInfo.GetVersionInfo(Application.StartupPath + "\\JSD_mF4.exe");

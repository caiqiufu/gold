...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New(ByVal poAPI As T4.API.Host, ByVal pstrMarketID As String)
        MyBase.New()
        ...
        moHost.MarketData.GetMarket(pstrMarketID, Sub(e)
                                                      ' This places process on GUI thread.
                                                      If Me.IsHandleCreated Then
                                                          Me.BeginInvoke(New OnMarketListComplete(AddressOf MarketListComplete), e)
                                                      Else
                                                          MarketListComplete(e)
                                                      End If
                                                  End Sub)
    ...
    Private Sub MarketListComplete(e As MarketListEventArgs)
        ...
        Dim oMarket As Market = e.Markets(mstrMarketID)
...
#Region " Market Updates "
    ...
    Private Sub moMarket_MarketDepthUpdate(ByVal e As MarketDepthUpdateEventArgs) Handles moMarket.MarketDepthUpdate
    ...
    Private Sub OnMarketDepthUpdate(ByVal e As MarketDepthUpdateEventArgs)
        ...
        Try
            ...
            If e.Depth.Bids.Count > 0 Then
                txtBid.Text = e.Market.PriceToDisplay(e.Depth.Bids(0).Price)
                txtBidVol.Text = e.Depth.Bids(0).Volume.ToString
            End If

            ' Best offer.
            If e.Depth.Offers.Count > 0 Then
                txtOffer.Text = e.Market.PriceToDisplay(e.Depth.Offers(0).Price)
                txtOfferVol.Text = e.Depth.Offers(0).Volume.ToString
            End If

            ' Last trade.
            With e.Market.GetTrade
                txtLast.Text = e.Market.PriceToDisplay(.Price)
                txtLastVol.Text = .Volume.ToString
                txtLastVolTotal.Text = .TotalVolume.ToString
            End With

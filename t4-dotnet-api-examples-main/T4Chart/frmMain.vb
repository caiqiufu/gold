...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Panel1.Size = New System.Drawing.Size(351, 453)
        ...
        Me.cboMarkets.Location = New System.Drawing.Point(87, 56)
        Me.cboMarkets.Name = "cboMarkets"
        Me.cboMarkets.Size = New System.Drawing.Size(258, 21)
        ...
        Me.lblExchange.Size = New System.Drawing.Size(73, 21)
        ...
        Me.cboContracts.Location = New System.Drawing.Point(87, 32)
        Me.cboContracts.Name = "cboContracts"
        Me.cboContracts.Size = New System.Drawing.Size(258, 21)
        ...
        Me.cboExchanges.Location = New System.Drawing.Point(87, 8)
        Me.cboExchanges.Name = "cboExchanges"
        Me.cboExchanges.Size = New System.Drawing.Size(258, 21)
        ...
        Me.DataGridView1.Location = New System.Drawing.Point(351, 0)
        Me.DataGridView1.Name = "DataGridView1"
        Me.DataGridView1.ReadOnly = True
        Me.DataGridView1.Size = New System.Drawing.Size(593, 453)
...
#Region " Form and Control Events "
    ...
    Private Sub cboExchanges_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboExchanges.SelectedIndexChanged
        ...
        For Each oContract As Contract In mSelectedExchange.Contracts.GetSortedList
    ...
    Private Sub cboContracts_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboContracts.SelectedIndexChanged
        ...
        mSelectedContract.GetMarkets(0, StrategyType.None, Sub(e2)
                                                               ' Invoke the update to the GUI thread.
                                                               If Me.InvokeRequired Then
                                                                   Me.BeginInvoke(New OnMarketListComplete(AddressOf PopulateMarkets), e2)
                                                               Else
                                                                   PopulateMarkets(e2)
                                                               End If
                                                           End Sub)

        ' Load the expired market list for the contract. This is done with a market fileter so as to prevent loading spread markets.
        mSelectedContract.GetMarkets(0, StrategyType.None, True, Sub(e2)
                                                                     ' Invoke the update to the GUI thread.
                                                                     If Me.InvokeRequired Then
                                                                         Me.BeginInvoke(New OnMarketListComplete(AddressOf PopulateExpiredMarkets), e2)
                                                                     Else
                                                                         PopulateExpiredMarkets(e2)
                                                                     End If
                                                                 End Sub)
...
#Region " Operations "
    ...
    Private Sub PopulateExchanges()
        ...
        Try
            ...
            For Each oExchange As Exchange In moHost.MarketData.Exchanges.GetSortedList
    ...
    Private Sub PopulateMarkets(e As MarketListEventArgs)
    ...
    Private Sub PopulateExpiredMarkets(e As MarketListEventArgs)
...
#Region " API Events "
    ...
    Private Sub PostLogin()
        ...
        If Not (moHost.MasterUser.IsInRole("Charting") OrElse moHost.MasterUser.IsInRole("BasicCharting")) Then
            ...
            Do While oChartData.Read
                ...
                Select Case oChartData.Change
                    ...
                    Case ChartDataChange.TradeBar
                        ...
                        moTable.Rows.Add(
                            oChartData.TradeDate,
                            oChartData.BarStartTime,
                            oChartData.OpenPrice,
                            oChartData.HighPrice,
                            oChartData.LowPrice,
                            oChartData.ClosePrice,

    ...
    Private Sub moBarData_DataLoadComplete(ByVal sender As Object, ByVal e As T4.API.ChartData.DataLoadCompleteEventArgs) Handles moBarData.DataLoadComplete
        ...
        Try
            ...
            For i As Integer = 0 To moBarData.TradeBars.Count - 1
                ...
                Trace.WriteLine(String.Format("TradeDate: {6}, Time: {5}, Open: {0}, High: {1}, Low: {2}, Close: {3}, Volume: {4}", oBar.OpenPrice, oBar.HighPrice, oBar.LowPrice, oBar.ClosePrice, oBar.Volume, oBar.Time, oBar.TradeDate))
...
#Region " Form and Control Events "
    ...
    Private Sub cboContracts_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboContracts.SelectedIndexChanged
        ...
        moSelectedContract.GetMarkets(0, StrategyType.None, Sub(e2)
...
#Region " Operations "
    ...
    Private Sub ContractListComplete()
        ...
        If moSelectedExchange IsNot Nothing Then
            ...
            Try
                ...
                For Each oContract As Contract In moSelectedExchange.Contracts.GetSortedList

      ...
      private void PlaceBtn_Click(object sender, EventArgs e)
      {
         try
         {
            if (checkOrderAttributes())
            {
               ...
               {
                  DateTime validTill = DateTime.SpecifyKind(new DateTime(DurationDateTime.Value.Year, DurationDateTime.Value.Month, DurationDateTime.Value.Day), DateTimeKind.Utc);

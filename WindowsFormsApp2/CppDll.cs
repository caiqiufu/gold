...
namespace WindowsFormsApp2
{
    class CppDll
    {
        ...
        /// <returns></returns>
        [DllImport("E:/OneDrive/07-svn/01-gold/Dll1/Debug/Dll1.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern IntPtr OpenBuyOrder(string price, string slippage, string lot);
        /// <summary>
        /// 开仓卖空
        /// </summary>
        /// <param name="price"></param>
        ...
        /// <returns></returns>
        [DllImport("E:/OneDrive/07-svn/01-gold/Dll1/Debug/Dll1.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern IntPtr test(ref double price, double slippage, double lot);
    }
}

...
{
    public class V4ClientWFB : V4Client
    {

        public DataGridView _GvPositions;
        public Button btn;
        public Form form;
        public V4ClientWFB(DataGridView gvPositions)
        {
        ...
        [DllImport("Dll1WFG0705.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <returns></returns>
        [DllImport("Dll1WFG0705.dll", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// </summary>
        /// <returns></returns>
        [DllImport("Dll1WFG0705.dll", EntryPoint = "Recover", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern IntPtr Recover();
        /// <summary>
        /// GetWatchWorlds
        /// </summary>
        /// <returns></returns>
        [DllImport("Dll1WFG0705.dll", EntryPoint = "GetWatchWorlds", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]

    ...
    public partial class TradeForm : uClient.TradeForm
    {
        ...
        public TradeForm(MainFormPara mainFormPara) : base()
        {
            if (mainFormPara == null)
            {
                ...
                mainFormPara.BrokerCode = "SUI";
                mainFormPara.BrokerName = "SUI";
        ...
        public override void GeneratePlatformObj()
        {
            switch (_Platform.PlatformNo)
            {
                case (int)Comm.Enum.Platform.MF4:
                    _MF4 = new MF4(_Config, _MyConfig, _Broker, _Account, _TradeSymbol, _Log, bgwBroberQuote, bgwOrderUpdate, base.gvPositions, quotaDisplayPanel, accountDisplay);
                ...
                case (int)Comm.Enum.Platform.V4:
                    _V4 = new V4(_Config, _MyConfig, _Broker, _Account, _TradeSymbol, _Log, bgwBroberQuote, bgwOrderUpdate, base.gvPositions, quotaDisplayPanel, accountDisplay);

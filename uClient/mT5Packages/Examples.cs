...
namespace Test
{
    class Examples
    {
        ...
        private void QuoteHist()
        {
            ...
            api.RequestQuoteHistoryMonth(api.Symbols.Infos.First().Key, 2021, 5, 27);//, DateTime.Now.AddDays(-1), DateTime.Now.AddDays(1));
            Console.WriteLine("Press any key...");
            Console.ReadKey();
        }
        ...
        List<Bar> ConvertToTimeframe(List<Bar> bars, int minutes)
        {
            ...
            int minutesFromDayStart = (int)time.Subtract(new DateTime(time.Year, time.Month, time.Day)).TotalMinutes;
            int dif = minutesFromDayStart % minutes;
            time = time.AddMinutes(-dif - minutes);
            bar.Time = time;
        ...
        void Connect()
        {
            ...
            //			ModalMais - DMA4 - Beta
            //187.44.118.230:443 ping:
            //			187.44.118.231:443 ping:
            //			189.125.122.15:443 ping:
            //			189.125.122.9:443 ping:
            //			179.191.127.204:443 ping:
            //			179.191.127.205:443 ping:
        ...
        void Proxy()
        {
            ...
            qc.OnConnectProgress += Qc_OnConnectProgress;
            qc.Connect();
            Console.WriteLine("Done");
            Console.ReadKey();
        }
        ...
        void RealtimeQuotes()
        {
            ...
            //var qc = new MT5API(2233358, "W3lc0m3123", "mt5trial.exness.com", 443);
            //var qc = new MT5API(32115516, "baunn2wo", "195.201.195.179", 443);
            //var qc = new MT5API(12022751, "y5webvvd", "173.212.252.7", 443);
            //var qc = new MT5API(185582, "ujrXoz0l", "mt5-pep-d01-miami-01.mt4proxy.com", 443);
            //var qc = new MT5API(22811197, "PHunghungdigita", "mt5demo201.loginandtrade.com", 443);
            //2.58.47.226:443
            //2.58.47.214:443
            //var qc = new MT5API(9956, "TYTY1212", "2.58.47.214", 443);
            //MT5API qc = new MT5API(9956, "TYTY1212", "2.58.47.226", 443);
            //var qc = new MT5API(17703, "Mill2021", "101.97.56.165", 443);
            //var qc = new MT5API(50838267, "jfwchz8m", "178.255.202.119", 443);
            //var qc = new MT5API(41290653, "GRA51ha7kyHw", "51.89.158.138", 443);
            //			208.116.148.207:443
            //78.41.199.82:443
            //62.67.221.27:443
            //78.41.197.85:443
            ...
            //4.14.216.168:443
            //77.77.177.106:443
            //var qc = new MT5API(460616, "F7L6vYS6", "208.116.148.207", 443);
            //var qc = new MT5API(750203, "sporting1", "35.195.178.79", 443);
            //var qc = new MT5API(45045, "msms1616", "95.216.98.166", 443);
            //var qc = new MT5API(6011, "c24242424", "136.244.109.100", 443);
            //var qc = new MT5API(89825, "bP4oQ3aL6y", "195.128.79.73", 443);
            //var qc = new MT5API(2573542, "23eHg7Z6", "211.72.241.29", 443);
            //var qc = new MT5API(3114292, "tr8pqube", "87.239.190.115", 1950);
            //var qc = new MT5API(20814749, "pkBcmEn!R9toXbJ!", "mt5-demo.binary.com", 443);
            var qc = new MT5API(5073959, "delayed123", "95.179.222.25", 443);
            qc.OnConnectProgress += Qc_OnConnectProgress1;
            Console.WriteLine("Connecting...");
            ...
            while (qc.GetQuote(symbol) == null)
                Thread.Sleep(1);
            Console.WriteLine(qc.GetQuote(symbol));
        ...
        private void Qc_OnConnectProgress1(MT5API sender, ConnectEventArgs args)
        {
        ...
        private void Qc_OnConnectProgress(MT5API sender, ConnectEventArgs args)
        {
            Console.WriteLine(args.Progress);
        }
        ...
        void MarketOrder()
        {
            ...
            //var api = new MT5API(18457, "HXEKon72fs", "13.114.200.108", 443);
            //var api = new MT5API(18574, "uaDZ3mjC6", "13.114.200.108", 443);
            //706605 /g4zwusug // FPMarkets demo
            //api.Subscribe(symbol);
            //while (api.GetQuote(symbol) == null)
            //	Thread.Sleep(1);
            //var api = new MT5API(99083840, "ychqluy5", "112.126.96.179", 443); //xdl demo
            ...
            //var api = new MT5API(34456308, "co0hcwrb", "78.140.180.198", 443); //mq demo
            //var api = new MT5API(62401092, "Chien123456", "35.157.110.232", 443); //xmglobal demo
            //var api = new MT5API(910916, "I-VD7yS1", "54.36.164.46", 443); //HonorFX 
            //var api = new MT5API(19053740, "4xpskbmf", "40.74.136.17", 443); 
            var api = new MT5API(58045834, "dlvzwfn0", "78.140.180.198", 443); //mq demo
                                                                               //var api = new MT5API(582532, "wsohENai0R", "185.63.221.191", 443);
